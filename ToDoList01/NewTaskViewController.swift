...
/// Custom implemantation of the 'ButtonFactory' protocol
final class FilledButtonFactory: ButtonFactory {
    
    /// The title of the button
    let title: String
    
    /// The bacground color of the button
    let color: UIColor
    ...
    ///   - color: The bacground color of the button.
    ...
    /// Create a button with the predefined title, color and action.
    ///
    ...
    func createButton() -> UIButton {
        ...
        // Create a filled button configuration and set the bacground color and title
